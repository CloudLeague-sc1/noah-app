...
class RichTextStyle {
  ...
  RichTextStyle.clear();
  RichTextStyle(this.isBold, this.isItalic, this.isEmphasized,
...
List<RichTextSpan> traverseRichText(RichText richText, RichTextStyle style) {
  return richText
      .map((e) => traverseRichTextInner(e, style))
      .expand((e) => e)
      .toList();
}

List<RichTextSpan> traverseRichTextInner(
    RichTextInner model, RichTextStyle currentStyle) {
